        ...
        <div class="card">
          ...
          <form method="POST" id="searchx">
            <div class="row mb-2">
              ...
              <div class="col-sm-2">{!! Form::text('date',null,['class'=>'form-control datepick','id'=>'date1','data-language'=>'en','data-date-format'=>'yyyy-mm-dd','placeholder'=>'-- Pilih Tanggal --']) !!}</div>
              <div class="col-sm-2">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#searchx").on("submit",function(e){
      ...
      var dateT = $("#date1").val();
      var csrf = "{{ csrf_token() }}";
      var url = '{{ route('collector.track_collector_search') }}';
      $.ajax({
        url : url,
        data  : {users_collector_id:users_collector_id,dateT:dateT,_token:csrf},
        type : "POST",
