...
<div class="col-md-6">
  ...
  <div class="row">
    ...
    <div class="col-sm-6">{!! Form::text('posting_date',$row['DocDate'],['class'=>'form-control form-control-sm','readonly'=>true]) !!}</div>
  </div>
  <div class="row">
  ...
  <div class="row mb-3">
    <label class="col-sm-5 col-form-label fw-bolder">No Series Pajak</label>
    <div class="col-sm-6">{!! Form::text('NoSeriesPajak',$row['NoSeriesPajak'],['class'=>'form-control form-control-sm','readonly'=>true]) !!}</div>
  </div>
  <div class="row">
    ...
    <div class="col-sm-6">{!! Form::text('priceList',$customer['PriceList'],['class'=>'form-control form-control-sm','id'=>'priceList','readonly'=>true]) !!}</div>
  </div>
</div>