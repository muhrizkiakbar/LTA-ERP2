<div class="col-md-6">
  <div class="row">
    ...
    <div class="col-sm-7">{!! Form::text('customer',$CardCode,['class'=>'form-control form-control-sm','id'=>'cardCode','readonly'=>true]) !!}</div>
  </div>
  <div class="row">
    <label class="col-sm-4 col-form-label">Name</label>
    <div class="col-sm-7">{!! Form::text('name',isset($CardName) ? $CardName : '-',['class'=>'form-control form-control-sm','id'=>'name','readonly'=>true]) !!}</div>
  </div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-sm-7">{!! Form::text('customer_ref',$numAtCard,['class'=>'form-control form-control-sm','readonly'=>true]) !!}</div>
  </div>
  <div class="row mb-4">
    <div class="col-sm-4">{!! Form::text('local_currency',$local_currency,['class'=>'form-control form-control-sm','readonly'=>true]) !!}</div>
    <div class="col-sm-6">{!! Form::text('segment',isset($cseg4) ? $cseg4 : '-',['class'=>'form-control form-control-sm','readonly'=>true]) !!}</div>
  </div>
  <div class="row">
...
<div class="col-md-6">
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      @if (isset($closing))
        @if ($date==$closing)
        {!! Form::text('posting_date',$DocDate,['class'=>'form-control form-control-sm datepick','data-language'=>'en','data-date-format'=>'yyyy-mm-dd','id'=>'PostingDateX']) !!}
        @else
        {!! Form::text('posting_date',$date,['class'=>'form-control form-control-sm','id'=>'PostingDate','readonly'=>TRUE]) !!}
				<input type="hidden" id="PostingDateX" value="{{ date('Y-m-d') }}">
        @endif
      @endif
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-6">
      @if (isset($closing))
        @if ($date==$closing)
        {!! Form::text('document_date',$DocDate,['class'=>'form-control form-control-sm','readonly'=>true]) !!}
        @else
        {!! Form::text('document_date',$date,['class'=>'form-control form-control-sm','readonly'=>TRUE]) !!}
        @endif
      @endif
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-sm-6">{!! Form::text('priceList',$PriceList,['class'=>'form-control form-control-sm','id'=>'priceList','readonly'=>true]) !!}</div>
  </div>
</div>