      ...
      <table border="0" width="97%">
        <tr>
          ...
          <td class="text-center">
            <strong style="font-size: 14px;" style="top:20px;">KWITANSI</strong>
          </td>
      ...
      <table class="tablex" border="0" width="97%">
        <thead>
          <tr>
            ...
            <th style="border:1px solid;" class="text-center">Account</th>
        ...
        <tbody>
          ...
          <tr valign="top" bordercolor="#000000" height="25px">
            ...
            <td style="border-right: 1px solid;" class="text-center">{{ $item['AcctCode'] }}</td>
