...
<body style="background: #fff;">
  <div class="page-footer">
    {{ $header->U_NAME }} | {{ $header->DocNum }} | {{ date('d-m-Y H:i:s') }} | 
  </div>
        ...
        <tr>
          <td width="30%">
            <table style="font-size: 11px;">
              <tr>
                <td width="75px" height="15px">No Retur</td>
                <td>{{ $header->Series.'/'.$header->DocNum }}</td>
              </tr>
              <tr>
                <td height="15px">Reff No</td>
              ...
              <tr>
                ...
                <td>{{ $header->CardCode }}</td>
              </tr>
              <tr>
                <td height="15px">Sales</td>
                <td>{{ $header->SlpName }}</td>
              </tr>
            </table>
          </td>
      ...
      <table class="tablex" border="0" width="97%">
        <thead>
          <tr>
            ...
            <th style="border:1px solid;" class="text-center" width="100px">Disc %</th>
          ...
          <table class="tablex" border="0" width="97%">
            <tr valign="top" style="border: none !important">
              <td colspan="5" rowspan="6" style="border-top: 1px solid;">
                @php
                  $totalSum = $docTotal + $header->VatSum;
                @endphp
              ...
              <td style="border-top: 1px solid;" class="text-right">{{ rupiahnon($docTotal) }}</td>
            </tr>
            <tr valign="top" style="border: none !important;">
