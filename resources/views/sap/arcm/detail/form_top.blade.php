<div class="col-md-6">
  ...
  <div class="row">
	...
	<div class="row">
    <label class="col-sm-4 col-form-label">NumAtCard</label>
    <div class="col-sm-7">{!! Form::text('numAtCard',$header->NumAtCard,['class'=>'form-control form-control-sm','readonly'=>true]) !!}</div>
  </div>
  <div class="row mb-4">
...
<div class="col-md-6">
  ...
  <div class="row">
    ...
    <div class="col-sm-6">{!! Form::text('posting_date',$header->DocDate,['class'=>'form-control form-control-sm','readonly'=>true]) !!}</div>
  </div>
  <div class="row">
