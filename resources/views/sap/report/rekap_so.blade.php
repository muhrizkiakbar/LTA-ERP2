...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#sync").on("submit",function(e){
      ...
      var sales = $("#sales").val();
      var csrf = "{!! csrf_token() !!}";
      var url = '{{ route('report.rekap_so_search') }}';
      $.ajax({
        url : url,
        data  : {timeFrom:timeFrom,timeTo:timeTo,tipe:tipe,dateFrom:dateFrom,user:user,cabang:cabang,status:status,sales:sales,_token:csrf},
        type : "POST",
