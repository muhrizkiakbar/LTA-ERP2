...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#sync").on("submit",function(e){
      ...
      var plat = $("#plat").val();
      var csrf = "{!! csrf_token() !!}";
      var url = '{{ route('report.rekap_so_plat_search') }}';
      $.ajax({
        url : url,
        data  : {timeFrom:timeFrom,timeTo:timeTo,tipe:tipe,dateFrom:dateFrom,user:user,cabang:cabang,status:status,plat:plat,_token:csrf},
        type : "POST",
