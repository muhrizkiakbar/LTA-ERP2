  ...
  <div class="page">
    ...
    <div style="margin: -15px 20px 20px 20px;">
      ...
      @php
          $nox = $no++;
      @endphp
      <table class="tablex" border="0" width="97%" {!! $nox==1 ? count($separate['lines']) <= 10 ? 'style="margin-bottom:40px; margin-top:-15px;"' : 'style="margin-bottom:30px; margin-top:20px;"' : 'style="margin-bottom:30px; margin-top:20px;"'!!}>
        <thead>
          <tr>
            <th rowspan="2" style="border:1px solid;" class="text-center" height="20px">Barcode</th>
            <th rowspan="2" style="border:1px solid;" class="text-center" width="210px">Nama Barang</th>
            ...
            <th colspan="3" style="border:1px solid;" class="text-center" width="170px">Potongan Diskon</th>
            <th rowspan="2" style="border:1px solid;" class="text-center" width="85px">Harga Nett Pcs</th>
        ...
        <tbody>
          ...
          <tr valign="top" bordercolor="#000000" height="25px">
            <td style="border-right: 1px solid; border-left: 1px solid; font-size:11px;">{{ $item['barcode'] }}</td>
            ...
            <td style="border-right: 1px solid;" class="text-right">{{ rupiahnon($item['harga_satuan_nett']) }}</td>
      ...
      @endforeach
      <table class="tablex" border="0" width="97%" {!! $nox > 1 ? 'style="margin-top:-20px"' : 'style="margin-top:-20px"'!!}>
