  ...
  <div class="page">
    ...
    <div style="margin: -15px 20px 20px 20px;">
      ...
      @php
          $nox = $no++;
      @endphp
      <table class="tablex" border="0" width="97%" {!! $nox==1 ? count($separate['lines']) <= 10 ? 'style="margin-bottom:40px; margin-top:-15px;"' : 'style="margin-bottom:30px;"' : 'style="margin-bottom:30px; margin-top:20px;"'!!}>
        <thead>
          <tr>
            <th rowspan="2" style="border:1px solid;" class="text-center" width="20px" height="20px">No</th>
            <th rowspan="2" style="border:1px solid;" class="text-center" width="170px">Nama Barang</th>
            <th rowspan="2" style="border:1px solid;" class="text-center" >Barcode</th>
            <th rowspan="2" style="border:1px solid;" class="text-center" width="75px">Qty</th>
            <th rowspan="2" style="border:1px solid;" class="text-center" width="60px">Price</th>
            <th colspan="3" style="border:1px solid;" class="text-center" width="200px">Potongan Diskon</th>
            <th rowspan="2" style="border:1px solid;" class="text-center" width="90px">Jumlah <br> (Disc + PPN)</th>
          </tr>
          <tr>
            <th style="border:1px solid;" class="text-center">Reg. Diskon</th>
            <th style="border:1px solid;" class="text-center">Vol. Diskon</th>
        ...
        <tbody>
          ...
          <tr valign="top" bordercolor="#000000" height="25px">
            ...
            <td style="border-right: 1px solid;" class="text-right">{{ rupiahnon($item['docTotal2']) }}</td>
          </tr>
          @endforeach
        </tbody>
      </table>   
      @endforeach
      <table class="tablex" border="0" width="97%" {!! $nox > 1 ? 'style="margin-top:20px"' : 'style="margin-top:30px"'!!}>
