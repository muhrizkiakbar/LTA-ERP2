      ...
      <table class="tablex" border="0" width="97%" {!! $nox==1 ? count($separate['lines']) <= 8 ? 'style="margin-bottom:0px; margin-top:-15px;"' : 'style="margin-bottom:30px;"' : 'style="margin-bottom:20px;"'!!}>
        <thead>
          <tr>
            ...
            <th rowspan="2" style="border:1px solid;" class="text-center" width="60px">Jumlah</th>
          </tr>
          <tr>
            <th style="border:1px solid;" class="text-center">Reg. Diskon</th>
            <th style="border:1px solid;" class="text-center">Vol. Diskon</th>
            <th style="border:1px solid;" class="text-center">Lot Sell</th>
          </tr>
        </thead>
        <tbody>
          @php
          ...
          <tr valign="top" bordercolor="#000000" height="25px">
            ...
            <td style="border-right: 1px solid; font-size:12px;">{{ $item['itemDesc'] }}</td>
            <td style="border-right: 1px solid; font-size:12px;">{{ $item['barcode'] }}</td>
            ...
            <td style="border-right: 1px solid; font-size:12px;" class="text-right">
