  ...
  <div class="page">
    ...
    <div style="margin: -15px 20px 20px 20px;">
      ...
      @if ($nox==1) {{-- Cek Jika Perulangan --}}
        ...
        @else
          @php
            $style = 'style="margin-bottom:30px; margin-top:-15px;"';
