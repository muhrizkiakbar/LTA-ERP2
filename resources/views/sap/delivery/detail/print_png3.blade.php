  ...
  <div class="page">
    ...
    <div style="margin: -15px 20px 20px 20px;">
      ...
      @php
          $nox = $no++;
      @endphp
      <table class="tablex" border="0" width="97%" {!! $nox==1 ? count($separate['lines']) <= 10 ? 'style="margin-bottom:40px; margin-top:-15px;"' : 'style="margin-bottom:30px;"' : 'style="margin-bottom:35px; margin-top:25px;"'!!}>
        <thead>
          <tr>
